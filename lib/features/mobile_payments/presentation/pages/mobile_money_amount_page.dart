...
class MobileMoneyAmountPage extends StatefulWidget {
  final String network;
  final String customerPhone;
  final String? otp;

  const MobileMoneyAmountPage(
      {Key? key, required this.network, required this.customerPhone, this.otp})
      : super(key: key);

  @override
  _MobileMoneyAmountPageState createState() => _MobileMoneyAmountPageState();
}

class _MobileMoneyAmountPageState extends State<MobileMoneyAmountPage> {
